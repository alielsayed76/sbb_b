...
LOGS = logging.getLogger("اعداد ابو المجد")
...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await sbb_b(JoinChannelRequest("@G5_7A"))
    except BaseException:
        pass
    try:
        await sbb_b(JoinChannelRequest("@G5_7F"))
    except BaseException:
        pass
    try:
    ...
    try:
        if BOTLOG:
            Config.JMTHONLOGO = await sbb_b.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/4ab7dfae41d0283ef0f81.jpg",
                caption="**تم تشغيل سورس ابو المجد  بنجاح لعرض الاوامر ارسل .الاوامر**",
                buttons=[(Button.url("كروب المساعدة", "https://t.me/G5_7F"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كروب بوت ابو المجد", sbb_b, Config.TG_BOT_USERNAME, descript, photobt
        )
