...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="⌯︙BY : @G5_7A🎀",parse_mode="html")
  await vois.delete()
...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="⌯︙BY : @G5_7A 🤲🏻☪️",parse_mode="html")
  await vois.delete()
@sbb_b.on(admin_cmd(outgoing=True, pattern="ثيم$"))
async def jepThe(theme):
  rl = random.randint(2,510)
  url = f"https://t.me/GSSSD/{rl}"
  await theme.client.send_file(theme.chat_id,url,caption="⌯︙THEME BY : @G5_7A 🎊",parse_mode="html")
  await theme.delete()
