...
async def on_new_private_message(event):
    ...
    if event.chat_id == 1050898456:
        await event.client.send_message(chat, "**⪼ اطـلق هـلاو مطورتي الغـالية ابو المجد اننـي محظـوظ لقدومـك الـي 🙈♥️𓆰*")
        reason = "**يجب عليك الترحيب بمطور السورس **"
...
async def approve_p_m(event):
    ...
    if len(approved_users) > 0:
        for user in approved_users:
            APPROVED_PMs += f"• 𓆰 Abo Elmaged ََِِ𝘀ُُ𝗼ًًٍٍ𝗨ًًٍٍ𝗥ََِِ𝗰ََِِ𝗲 - 𝑨𝑷𝑷𝑹𝑶𝑽𝑬𝑫𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
    else:
