...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("السورس", "https://t.me/G5_7A"),
                Button.url(
                    "المطور",
                    "https://t.me/G5_7B",
                ),
...
اوامر فارات سورس ابو المجد  @G5_7A""",
        buttons=[
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @III6x 
